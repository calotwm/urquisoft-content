...
body.light{
  ...
  --mag:#B0006B; --mag-soft:#B0006B; --mag-dark:#7A004C;
  --grain-op:0.06;
...
body.magenta{
  --w100:#161219; --w85:rgba(22,18,25,0.85); --w82:rgba(22,18,25,0.82);
  --w75:rgba(22,18,25,0.75); --w72:rgba(22,18,25,0.72); --w65:rgba(22,18,25,0.66);
  --w60:rgba(22,18,25,0.62); --w50:rgba(22,18,25,0.55); --w45:rgba(22,18,25,0.5);
  --w35:rgba(22,18,25,0.38); --w28:rgba(22,18,25,0.32); --w22:rgba(22,18,25,0.26);
  --w16:rgba(22,18,25,0.18);
  --g1:rgba(255,255,255,0.55); --g2:rgba(255,255,255,0.30); --g3:rgba(255,255,255,0.12); --gh:rgba(255,255,255,0.85);
  --bg:#E6008C; --bg1:#CC007E; --bg2:#A60068; --bg3:#720046;
  --glow1:rgba(255,255,255,0.30); --glow2:rgba(0,0,0,0.20);
  --mag:#161219; --mag-soft:#161219; --mag-dark:#000000;
  --teal:#FFFFFF;
  --grain-op:0.07;
  --edge:rgba(22,18,25,0.55);
  --inset1:rgba(0,0,0,0.14); --inset2:rgba(0,0,0,0.06);
  --shadow:rgba(0,0,0,0.30);
  --cta1:#161219; --cta2:#161219; --cta-border:rgba(22,18,25,0.9);
...
body.magenta .pill-myth{border-color:rgba(22,18,25,0.4)}
body.magenta .pill-problem{border-color:rgba(22,18,25,0.5);color:#161219;background:rgba(22,18,25,0.08)}
body.magenta .pill-reality{border-color:rgba(255,255,255,0.7);color:#FFFFFF;background:rgba(255,255,255,0.16)}
body.magenta .close h2 .grad{background:linear-gradient(135deg,#7EE3C6 0%,#2FA284 100%);-webkit-background-clip:text;background-clip:text;color:transparent}
...
.swipe .arr{color:var(--mag);font-size:26px}
...
.pill-problem{border:1px solid rgba(204,0,126,0.5);color:var(--mag-soft);background:rgba(204,0,126,0.10)}
...
h2{font-weight:800;letter-spacing:-0.02em;font-size:80px;line-height:1.12;position:relative;white-space:nowrap}
...
.close h2{font-size:78px;line-height:1.14;white-space:normal;color:var(--w100)}
...
.statement{font-weight:800;letter-spacing:-0.02em;font-size:76px;line-height:1.12;position:relative;z-index:1;white-space:normal;color:var(--w100)}
.statement .mag{color:var(--mag-soft)}
...
.statrow .num{font-weight:800;font-size:128px;line-height:1;letter-spacing:-0.04em;background:linear-gradient(135deg,var(--mag-soft) 0%,var(--mag-dark) 100%);-webkit-background-clip:text;background-clip:text;color:transparent}
...
.rowline .n{flex:none;width:52px;height:52px;border-radius:999px;display:flex;align-items:center;justify-content:center;font-weight:800;font-size:24px;color:#fff;background:linear-gradient(135deg,var(--mag-soft),var(--mag-dark));box-shadow:0 0 16px rgba(204,0,126,0.4)}
...
.rowline .t{font-size:36px;font-weight:600;line-height:1.2;color:var(--w100)}
...
.optrow .letter{flex:none;width:56px;height:56px;border-radius:16px;display:flex;align-items:center;justify-content:center;font-weight:800;font-size:28px;color:#fff;background:linear-gradient(135deg,var(--mag-soft),var(--mag-dark));box-shadow:0 0 16px rgba(204,0,126,0.4)}
.optrow .t{font-size:34px;font-weight:600;color:var(--w100);line-height:1.2}
...
.bigq{font-weight:800;font-size:68px;line-height:1.14;letter-spacing:-0.02em;color:var(--w100);position:relative;z-index:1;white-space:normal}
.bigq .teal{color:var(--teal)}
.bigq .mag{color:var(--mag-soft)}
...
.fstep .fnum{width:44px;height:44px;border-radius:999px;display:flex;align-items:center;justify-content:center;font-weight:800;font-size:20px;color:#fff;background:linear-gradient(135deg,var(--mag-soft),var(--mag-dark));box-shadow:0 0 14px rgba(204,0,126,0.4)}
...
.farr{align-self:center;color:var(--mag);font-size:34px;font-weight:800;flex:none}
...
.metrics .num{font-size:170px;font-weight:800;letter-spacing:-0.04em;line-height:1;background:linear-gradient(135deg,var(--mag-soft) 0%,var(--mag-dark) 100%);-webkit-background-clip:text;background-clip:text;color:transparent}
...
.search .bar .cursor{width:3px;height:36px;background:var(--mag);animation:blink 1s step-end infinite;flex:none}
...
.search .res .ri{flex:none;width:36px;height:36px;border-radius:10px;background:linear-gradient(135deg,var(--mag-soft),var(--mag-dark));display:flex;align-items:center;justify-content:center;font-weight:800;color:#fff;font-size:17px}
...
.quoteauth .marks{font-size:110px;font-weight:800;line-height:.4;color:var(--mag-dark);opacity:.35}
...
.quoteauth .author .avatar{flex:none;width:66px;height:66px;border-radius:999px;background:linear-gradient(135deg,var(--mag-soft),var(--mag-dark));display:flex;align-items:center;justify-content:center;font-weight:800;font-size:22px;color:#fff;box-shadow:0 0 18px rgba(204,0,126,0.4)}
...
.scene .author .avatar{flex:none;width:52px;height:52px;border-radius:999px;background:linear-gradient(135deg,var(--mag-soft),var(--mag-dark));display:flex;align-items:center;justify-content:center;font-weight:800;font-size:18px;color:#fff}
...
function html(title, tag, mainHtml, pipOn, swipe, extraCss, opts) {
  ...
  const theme = o.theme === 'light' ? 'light' : (o.theme === 'magenta' ? 'magenta' : '');
  const w = o.w || 1080;
  const h = o.h || 1350;
  const noFooter = !!o.noFooter;
  const pips = Array.from({ length: pipsN }, (_, i) =>
    `<span class="pip${i + 1 === pipOn ? ' on' : ''}"></span>`).join('');
  const sizeCss = `html,body{width:${w}px;height:${h}px;overflow:hidden}.slide{width:${w}px;height:${h}px}`;
  const footer = noFooter ? '' : `  <footer>
...
<title>${title}</title>
${FONT}
<style>${CSS}${extraCss || ''}${sizeCss}</style>
</head>
<body class="${theme}">
<div class="grain"></div>
<div class="slide">
