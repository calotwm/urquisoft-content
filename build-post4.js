...
.shot{position:relative;z-index:1;width:100%;max-width:920px;aspect-ratio:2.1;border-radius:24px;border:1px solid rgba(204,0,126,.5);background:linear-gradient(135deg,rgba(204,0,126,.10) 0%,rgba(204,0,126,.02) 100%);box-shadow:0 10px 40px rgba(204,0,126,.25),inset 0 1px 0 rgba(255,255,255,.15);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;overflow:hidden}
